...
@WebServlet("/ch09/getSession") // 7CD68D56BAC74327CAB95727FECA15E3
...
//		System.out.println(Arrays.toString(fruits));
		...
		out.print("<h1>price: " + price + ", uid: " + uid + "</h1><br>");
		out.print("<h1>" + Arrays.toString(fruits) + "</h1><br>");
		out.print("<h1>isNew: " + session.isNew()+"</h1><br>");
		out.print("<h1>id: " + sessionId + "</h1><br>");
		out.print("<h1>MaxInactiveInterval: " + interval + " 초</h1><br>");
