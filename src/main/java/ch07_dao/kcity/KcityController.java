...
public class KcityController extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		switch(action) {
		case "list":
			  String district_ = request.getParameter("district");
			  district = (district_ == null || district_.equals("")) ? "Kyonggi" : district_;
			  String num_ = request.getParameter("num");
			  int num = (num_ == null || num_.equals("")) ? 10 : Integer.parseInt(num_);
			  String offset_ = request.getParameter("offset");
			  int offset = (offset_ == null || num_.equals("")) ? 0 : Integer.parseInt(offset_);
